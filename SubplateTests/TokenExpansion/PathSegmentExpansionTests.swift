//
//  PathSegmentExpansionTests.swift
//  Subplate
//
...
class PathSegmentExpansionTests: XCTestCase {
    // Undefined Match
    ...
    func testMultiplePathSegmentVariables1() {
        ...
        let expressionToken = Token.Expression(TemplateExpression.PathSegment([variableSpecifier1,
            variableSpecifier2]))
