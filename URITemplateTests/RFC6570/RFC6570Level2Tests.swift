...
class RFC6570Level2ExampleTests: XCTestCase {
    ...
    func testLevel2Examples() {
        let reservedStringURITemplate1 = URITemplate(string: "{+var}")
        ...
        let reservedStringURITemplate2 = URITemplate(string: "{+hello}")
        ...
        let reservedStringURITemplate3 = URITemplate(string: "{+path}/here")
        ...
        let reservedStringURITemplate4 = URITemplate(string: "here?ref={+path}")
